        ...
        <li>
            <a href="admin-zone.jsp">
                ...
                <form action="delete-departmentAdmin" method="post">
                    <button class="dep">Delete DepartmentAdmin</button>
                </form>
        ...
        <li>
            <a href="admin-zone.jsp">
                ...
                <form action="add-departmentAdmin" method="post">
                    <button>Add DepartmentAdmin</button>
                </form>
            </a>
